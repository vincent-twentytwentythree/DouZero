#python train.py --gpu_devices 0,1,2,3,4,5,6,7 --num_actor_devices 3 --num_actors 6 --training_device 3 --save_interval 20 --load_model
python train.py --gpu_devices 0,1,2,3,4,5,6,7 --num_actor_devices -3 --num_actors 6 --training_device 4 --save_interval 20 --load_model --training_mode landlord
